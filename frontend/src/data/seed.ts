/**
 * Seed data ported from the vanilla JS prototype (app.js).
 *
 * In production this data comes from the backend API + Content_reference.csv.
 * For the MVP it lives client-side so the app is fully functional offline.
 */

import type { Character, ChallengeQuestion, LeaderboardEntry } from "@/types";
...
export const characters: Character[] = [
  ...
  },
  {
    ...
    voice:
      "chính trực, trang trọng, giàu đạo nghĩa và niềm tin vào điều thiện",
    challenge: [
...
export const demoLeaders: LeaderboardEntry[] = [
